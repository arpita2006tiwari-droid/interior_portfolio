    ...
    <section className="relative w-full h-screen flex flex-col md:flex-row overflow-hidden bg-[var(--color-background)]">
      ...
      <div className="w-full md:w-1/2 h-full flex flex-col justify-center px-6 md:px-16 pt-32 md:pt-0 z-10">
        <motion.div
          ...
          className="mono text-xs tracking-widest text-[var(--color-sage)] mb-8"
        >
        ...
        >
          Spaces that <br />
          <span className="italic-serif text-[var(--color-terracotta)]">feel like you.</span>
        </motion.h1>
        ...
        >
          We create considered interiors where architecture, material and light come together to tell a story.
        </motion.p>
      ...
      {/* Right 3D Scene */}
      <div className="absolute inset-0 md:relative w-full md:w-1/2 h-full z-0 opacity-40 md:opacity-100 pointer-events-auto">
        <motion.div 
          className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 z-20 pointer-events-none text-xs mono tracking-widest opacity-50 bg-white/20 backdrop-blur-sm px-4 py-2 rounded-full hidden md:block"
